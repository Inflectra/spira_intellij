...
import inflectra.idea.core.listeners.*;
import inflectra.idea.core.model.artifacts.*;
...
public class SpiraToolWindowFactory implements ToolWindowFactory {
  ...
  public static void reload(Project project) {
    ...
    SpiraTeamCredentials credentials = ApplicationManager.getApplication().getComponent(SpiraTeamCredentials.class);
  ...
  private void showInvalidInformation(Project project) {
    ...
    button.addActionListener(l -> {
      SpiraTeamLoginDialog dialog = new SpiraTeamLoginDialog(project, ApplicationManager.getApplication().getComponent(SpiraTeamCredentials.class));
      dialog.show();
    });
